 ...
 * @author loup626
 */
class BonusFeu extends ABonus {
   
    public static ArkanoidRebours rebour;
    
    public BonusFeu(ArkanoidJPanel panel) {
        super(panel, null, 0, 0, 0);
    }
    
    /** Creates a new instance of GrandeRaquette */
    public BonusFeu(ArkanoidJPanel panel, ArkanoidTimer timer, int x, int y) {
    ...
    public void action() {
        BonusFeu.rebour.initialiser();
        this.pere.enflammerBalles();
    }
    
    public void annuler() {
        this.pere.eteindreBalles();
    }
}