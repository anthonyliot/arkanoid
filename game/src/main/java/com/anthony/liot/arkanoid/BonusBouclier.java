 ...
 * @author loup626
 */
public class BonusBouclier extends ABonus {

    public static ArkanoidRebours rebour;

    public BonusBouclier(ArkanoidJPanel panel) {
        super(panel, null, 0, 0, 0);
    }
    
    /** Creates a new instance of GrandeRaquette */
    public BonusBouclier(ArkanoidJPanel panel, ArkanoidTimer timer, int x, int y) {
        super(panel, timer, x, y, 100);
    }
    ...
    public void action() {
        BonusBouclier.rebour.initialiser();
        this.pere.activerBouclier();
    }

    public void annuler() {
        this.pere.desactiverBouclier();
    }
}
