 ...
 * @author loup
 */
public class BonusAnnuleGlue extends ABonus{
   
    public static ArkanoidRebours rebour;
    
    public BonusAnnuleGlue(ArkanoidJPanel panel) {
        super(panel, null, 0, 0, 0);
    }
    
    /** Creates a new instance of GrandeRaquette */
    public BonusAnnuleGlue(ArkanoidJPanel panel, ArkanoidTimer timer, int x, int y) {
